...
<div class="registerForm">
	...
	<form action="<c:url value='/DefaultServlet'></c:url>" method="post">
		...
		<div class="formElement">
			<label class="formElementLabel" for="${Parameters.REPEAT_PASSWORD}"><fmt:message key="password.repeat"></fmt:message></label>
			<input name="${Parameters.REPEAT_PASSWORD}" type="password" />
		</div>

...
<div class="registerForm">
    ...
    <form action="<c:url value='/user/UserServlet'></c:url>" method="post">
        <input type="hidden" name="action" value="${Actions.UPDATE_DETAILS}" />
        <fieldset>
            <legend><fmt:message key="login.details" /></legend>
            <div class="formElement">
                <label class="formElementLabel" for="email"><fmt:message key="email" /></label>
                <input name="email" type="email" id="email" value="${sessionScope.customer.email}" placeholder="rastley@gmail.com"
            ...
            <div class="formElement">
                <label class="formElementLabel" for="password"><fmt:message key="password.new" /></label>
        ...
        <fieldset>
            ...
            <div class="formElement">
                ...
                <input name="firstName" type="text" id="firstName" value="${sessionScope.customer.firstName}"
            ...
            <div class="formElement">
                ...
                <input name="lastName1" type="text" id="lastName1" value="${sessionScope.customer.lastName1}" required
            ...
            <div class="formElement">
                ...
                <input name="lastName2" type="text" id="lastName2" value="${sessionScope.customer.lastName2}"
            ...
            <div class="formElement">
                ...
                <input name="phoneNumber" type="tel" id="phoneNumber" value="${sessionScope.customer.phoneNumber}" required
        ...
        <fieldset>
            ...
            <div class="formElement">
                ...
                <select id="${Parameters.DOCUMENT_TYPE_ID}" name="${Parameters.DOCUMENT_TYPE_ID}">
                    <option value="NIF" <c:if test="${sessionScope.customer.documentTypeId == 'NIF'}">selected</c:if>><fmt:message key="document.type.nif" /></option>
                    <option value="NIE" <c:if test="${sessionScope.customer.documentTypeId == 'NIE'}">selected</c:if>><fmt:message key="document.type.nie" /></option>
                    <option value="PPT" <c:if test="${sessionScope.customer.documentTypeId == 'PPT'}">selected</c:if>><fmt:message key="document.type.passport" /></option>
                </select>
            </div>
            <div class="formElement">
                <label class="formElementLabel" for="${Parameters.DOCUMENT_NUMBER}"><fmt:message key="document.number" /></label>
                <input name="${Parameters.DOCUMENT_NUMBER}" type="text" id="${Parameters.DOCUMENT_NUMBER}" value="${sessionScope.customer.documentNumber}" required

...
<div class="wizardForm">
	...
	<fieldset>
		...
		<div class="formElement">
			...
			<input type="text" id="bic" name="bic" style="width: 50%;" required>
		</div>
	</fieldset>
	<fieldset>
		...
		<div class="formElement">
			...
			pattern="([0-9]{4}\w?){3}([0-9{4}])$" required>
		</div>
		<div class="bunchedInlineFormElements">
			...
			<div class="mediumFormElement">
				<label class="formElementLabel" for="cvc">CVV</label>
				<input type="text" id="cvc" name="cvc" style="width: 64px;"
				pattern="[0-9]{3}" placeholder="000" required>	
			</div>
		</div>
	</fieldset>
